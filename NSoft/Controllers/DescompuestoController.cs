...
namespace NSoft.Controllers.Presupuesto
{
    ...
    public class DescompuestoController : ControllerBase
    {
        ...
        [HttpGet("plantillas")]
        [ProducesResponseType(typeof(ApiResponse<List<DescompuestoDto>>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ApiResponse<List<DescompuestoDto>>), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("buscar")]
        [ProducesResponseType(typeof(ApiResponse<List<DescompuestoDto>>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ApiResponse<List<DescompuestoDto>>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse<List<DescompuestoDto>>), StatusCodes.Status500InternalServerError)]
        ...
        [HttpGet("{id:int}")]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(ApiResponse<DescompuestoDto>), StatusCodes.Status500InternalServerError)]
